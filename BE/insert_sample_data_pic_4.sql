...
VALUES
    ...
    (2, 3, N'Tesla Model 3 2021 nhập Mỹ', N'Tesla Model 3 nhập Mỹ, pin 60 kWh. Xe đẹp máy ngon, Autopilot. Cần bán gấp.', 'PENDING', 950000000.00, CAST('2024-03-12 11:30:00' AS DATETIME)),
    ...
    (4, 6, N'VinFast VF 8 2023', N'VinFast VF 8 2023, pin 87.7 kWh, màu xám bạc. Xe cao cấp.', 'SOLD', 850000000.00, CAST('2024-03-22 08:30:00' AS DATETIME)),
    ...
    (8, 12, N'VinFast VF 9 2023', N'VinFast VF 9 2023, pin 123 kWh, màu trắng đen, sporty.', 'APPROVED', 990000000.00, CAST('2024-03-30 09:20:00' AS DATETIME)),
    (9, 13, N'Audi e-tron 2022 cao cấp', N'Audi e-tron 2022, pin 95 kWh phiên bản cao cấp, full option.', 'APPROVED', 980000000.00, CAST('2024-04-01 16:40:00' AS DATETIME)),
    (10, 15, N'Kia EV6 2023 mới', N'Kia EV6 2023, pin 77.4 kWh mới ra mắt, thiết kế trẻ trung.', 'PENDING', 920000000.00, CAST('2024-04-03 10:50:00' AS DATETIME)),
    (11, 7, N'Mercedes EQC 2022', N'Mercedes EQC 2022, pin 80 kWh màu đỏ, xe gia đình.', 'SOLD', 950000000.00, CAST('2024-04-05 11:10:00' AS DATETIME)),
    ...
    (14, 4, N'Porsche Taycan 2023', N'Porsche Taycan 2023, pin 93.4 kWh màu xanh, chạy xa.', 'SOLD', 990000000.00, CAST('2024-04-09 10:30:00' AS DATETIME)),
    (15, 6, N'Hyundai Ioniq 5 2023', N'Hyundai Ioniq 5 2023, pin 72.6 kWh đời 2023.', 'APPROVED', 880000000.00, CAST('2024-04-10 13:20:00' AS DATETIME)),
